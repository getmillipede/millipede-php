...
We accept bug reports via issues created on [Github](https://github.com/getmillipede/millipede-php/issues).
...
- **Always try the [master branch](https://github.com/getmillipede/millipede-php)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/getmillipede/millipede-php/pull).
